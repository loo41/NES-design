...
export const Props = {
  public: {
    ...
    data: [
      ...
      {
        arg: 'twinkleDelay',
        des: 'twinkle time / 选择后闪烁时间',
        type: 'number | boolean',
        default: '2000',
      },
    ],
    footer: 'Radio / RadioGroup',
  },
  radioGroup: {
    columns: columns,
    data: [
      { arg: 'value', des: 'choose value / 选择的值', type: 'string', default: '-' },
      {
        arg: 'defaultValue',
        des: 'default value / 默认选中的值',
        type: 'string',
        default: '-',
      },
      {
        arg: 'options',
        des: 'radio option /单选选项组',
        type: 'Option[]',
        default: '-',
      },
      {
  ...
  radio: {
    ...
    data: [
      {
        arg: 'value',
        des: 'radio input value / Radio Input 的 Value，配合 RadioGroup 使用',
        type: 'string',
        default: '-',
      },
      {
  ...
  option: {
    ...
    data: [
      {
        arg: 'label',
        des: 'radio children / 展示的名称',
        type: 'string',
        default: '-',
      },
      {
        arg: '...Radio',
        des: 'Radio attrs / Radio 属性',
        type: 'RadioProps',
        default: '-',
      },
    ],
